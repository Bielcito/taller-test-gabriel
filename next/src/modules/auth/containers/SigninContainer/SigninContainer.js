...
import { combine, condition, required, minLength, email, equalsField, username, password } from 'app/lib/form/validation'
...
const validations = {
  name: combine([required, username]),
  email: combine([required, email]),
  password: combine([required, minLength(6), password]),
